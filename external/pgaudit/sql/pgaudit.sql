...
ALTER ROLE regress_user1 SET pgaudit.polar_mode = false;
...
ALTER ROLE regress_user2 SET pgaudit.polar_mode = false;
...
CREATE DATABASE contrib_regression_pgaudit1;
ALTER DATABASE contrib_regression_pgaudit1 RENAME TO contrib_regression_pgaudit2;
...
alter system reset pgaudit.polar_mode;
select pg_reload_conf();