DO $$
BEGIN
   IF pg_catalog.current_database() OPERATOR(pg_catalog.<>) pg_catalog.current_setting('cron.database_name') 
   AND pg_catalog.current_database() OPERATOR(pg_catalog.<>) 'contrib_regression' 
   AND pg_catalog.current_database() OPERATOR(pg_catalog.<>) 'contrib_regression_pg_cron' THEN
...
-- DO $$
-- BEGIN
--     IF pg_catalog.current_setting('polar_compatibility_mode') OPERATOR(pg_catalog.=) 'ora' THEN 
