...
$node_primary->append_conf('postgresql.conf', "max_wal_size='8GB'");
...
# $node_standby->stop; // TODO fast stop after promote will support by logindex patch
my $standby_datadir = $node_standby->data_dir;
PostgreSQL::Test::Utils::system_or_bail(
	"pg_ctl stop -D $standby_datadir -mi");
...
PostgreSQL::Test::Utils::system_or_bail('tar', '-zxvf', $backup_file, '-C',
	$backup_path);
