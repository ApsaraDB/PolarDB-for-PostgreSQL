...
-- sub partition
alter table pt DETACH PARTITION pt_p0;  
create table pt_p0_1 (dist int, pt1 text, pt2 text, pt3 text, ptid int)  PARTITION BY hash(ptid);
create table pt_p0_subp1 partition of pt_p0_1 FOR VALUES with (MODULUS 2, REMAINDER 0); 
create table pt_p0_subp2 partition of pt_p0_1 FOR VALUES with (MODULUS 2, REMAINDER 1);
alter table pt attach partition pt_p0_1 FOR VALUES WITH ( MODULUS 7, REMAINDER 0 );
