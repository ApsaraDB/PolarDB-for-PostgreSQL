...
alter system set polar_px_enable_btbuild_cic_phase2 = 1;
select pg_reload_conf();
select pg_sleep(1);
create index concurrently px_t on px_test(id) with(px_build=on);
...
alter system reset polar_px_enable_btbuild_cic_phase2;
select pg_reload_conf();
select id into px_test_1 from generate_series(1, 1000) as id order by id desc;
create index concurrently px_t_1 on px_test_1(id);
...
select pg_reload_conf();
select pg_sleep(1);
create index concurrently px_t on px_test(id1, id2, id3, id4) with(px_build=on);
select itemoffset, data from bt_page_items('px_t', 1);
select itemoffset, data from bt_page_items('px_t', 2);
select itemoffset, data from bt_page_items('px_t', 3);
select itemoffset, data from bt_page_items('px_t', 4);
...
create index concurrently px_t_1 on px_test_1(id1, id2, id3, id4);
select itemoffset, data from bt_page_items('px_t_1', 1);
select itemoffset, data from bt_page_items('px_t_1', 2);
select itemoffset, data from bt_page_items('px_t_1', 3);
select itemoffset, data from bt_page_items('px_t_1', 4);
...
select pg_reload_conf();
select pg_sleep(1);
create index concurrently px_t on px_test(id1, id2, id3, id4, id5, id6, id7, id8, id9, id10, id11, id12, id13, id14, id15, id16, id17, id18, id19, id20, id21, id22, id23, id24, id25, id26, id27, id28, id29, id30, id31, id32) with(px_build=on);
select itemoffset, data from bt_page_items('px_t', 1);
select itemoffset, data from bt_page_items('px_t', 2);
select itemoffset, data from bt_page_items('px_t', 3);
select itemoffset, data from bt_page_items('px_t', 4);
...
create index concurrently px_t_1 on px_test_1(id1, id2, id3, id4, id5, id6, id7, id8, id9, id10, id11, id12, id13, id14, id15, id16, id17, id18, id19, id20, id21, id22, id23, id24, id25, id26, id27, id28, id29, id30, id31, id32);
select itemoffset, data from bt_page_items('px_t_1', 1);
select itemoffset, data from bt_page_items('px_t_1', 2);
select itemoffset, data from bt_page_items('px_t_1', 3);
select itemoffset, data from bt_page_items('px_t_1', 4);
...
drop table if exists px_test;
create table px_test(id int);
create index concurrently px_t on px_test(id) with(px_build=off);
drop table if exists px_test;
create table px_test(id int);
create index concurrently px_t on px_test(id) with(px_build=finish);
drop table if exists px_test;
create table px_test(id int);
create index concurrently px_t on px_test(id) with(px_build=true);
drop table if exists px_test;
create table px_test(id int);
create index concurrently px_t on px_test(id) with(px_build='true');
alter system reset polar_px_enable_btbuild;
