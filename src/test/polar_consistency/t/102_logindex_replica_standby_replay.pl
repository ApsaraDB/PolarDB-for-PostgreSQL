...
foreach my $schedule (@prepared_schedules)
{
	...
	$node_primary->append_conf('postgresql.conf', 'checkpoint_timeout=60');
	...
	$node_replica1->append_conf('postgresql.conf', 'checkpoint_timeout=60');
	...
	$node_standby1->append_conf('postgresql.conf', 'checkpoint_timeout=60');
