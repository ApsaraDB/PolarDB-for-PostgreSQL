...
$result = $node_primary->safe_psql('postgres',
	"select injection_points_attach('fault_inject_for_first_contrecord', 'notice');"
);
...
# detach fault inject
$result = $node_primary->safe_psql('postgres',
	"select injection_points_detach('fault_inject_for_first_contrecord');");
print "detach fault inject: $result\n";
