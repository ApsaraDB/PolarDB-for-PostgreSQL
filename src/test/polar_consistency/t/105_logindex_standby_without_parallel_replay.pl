# 105_logindex_standby_without_parallel_replay.pl
#	  Test case: one primary node, one replica node and one standby node in single_replay mode.
#
...
#
# IDENTIFICATION
#	  src/test/polar_consistency/t/105_logindex_standby_without_parallel_replay.pl
use strict;
use warnings;
