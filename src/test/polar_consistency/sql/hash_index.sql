...
SELECT count(*) FROM hash_split_heap WHERE keycol < 20000;
SELECT * FROM hash_split_heap WHERE keycol < 20000 ORDER BY keycol DESC limit 3;

DELETE FROM hash_split_heap WHERE keycol < 100000;

SELECT count(*) FROM hash_split_heap WHERE keycol < 20000;
SELECT * FROM hash_split_heap WHERE keycol < 20000 ORDER BY keycol DESC limit 3;

INSERT INTO hash_split_heap SELECT a FROM generate_series(1, 100000) a;
...
DELETE FROM hash_split_heap where keycol % 2 = 1;

SELECT count(*) FROM hash_split_heap WHERE keycol < 20000;
SELECT * FROM hash_split_heap WHERE keycol < 20000 ORDER BY keycol DESC limit 3;


INSERT INTO hash_split_heap SELECT a FROM generate_series(1, 500000) a;
