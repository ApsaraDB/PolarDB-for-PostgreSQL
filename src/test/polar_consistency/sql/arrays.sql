...
select * from arrtest_f;
select * from arrtest_i;
...
create table t_t1 (f1 int8_tbl[]);
insert into t_t1 (f1[5].q1) values(42);
select * from t_t1;
update t_t1 set f1[5].q2 = 43;
select * from t_t1;
drop table t_t1;
