...
SELECT count(*) FROM numrange_test WHERE range_contains(nr, numrange(1.9,1.91));
SELECT * FROM numrange_test WHERE range_contains(nr, numrange(1.9,1.91));
SELECT count(*) FROM numrange_test WHERE nr @> numrange(1.0,10000.1);
SELECT * FROM numrange_test WHERE nr @> numrange(1.0,10000.1);
SELECT count(*) FROM numrange_test WHERE range_contained_by(numrange(-1e7,-10000.1), nr);
SELECT * FROM numrange_test WHERE range_contained_by(numrange(-1e7,-10000.1), nr);
SELECT count(*) FROM numrange_test WHERE 1.9 <@ nr;
SELECT * FROM numrange_test WHERE 1.9 <@ nr;

select count(*) from numrange_test where nr = 'empty';
select * from numrange_test where nr = 'empty';
select count(*) from numrange_test where nr = '(1.1, 2.2)';
select * from numrange_test where nr = '(1.1, 2.2)';
select count(*) from numrange_test where nr = '[1.1, 2.2)';
select * from numrange_test where nr = '[1.1, 2.2)';
select count(*) from numrange_test where nr < 'empty';
select * from numrange_test where nr < 'empty';
select count(*) from numrange_test where nr < numrange(-1000.0, -1000.0,'[]');
select * from numrange_test where nr < numrange(-1000.0, -1000.0,'[]');
select count(*) from numrange_test where nr < numrange(0.0, 1.0,'[]');
select * from numrange_test where nr < numrange(0.0, 1.0,'[]');
select count(*) from numrange_test where nr < numrange(1000.0, 1001.0,'[]');
...
select count(*) from numrange_test where nr > 'empty';
select * from numrange_test where nr > 'empty';
select count(*) from numrange_test where nr > numrange(-1001.0, -1000.0,'[]');
...
select count(*) from numrange_test2 where nr = 'empty'::numrange;
select * from numrange_test2 where nr = 'empty'::numrange;
select count(*) from numrange_test2 where nr = numrange(1.1, 2.2);
select * from numrange_test2 where nr = numrange(1.1, 2.2);
select count(*) from numrange_test2 where nr = numrange(1.1, 2.3);
