...
create view zv1 as select *,'dummy'::text AS junk from zt1;
...
CREATE a (id int PRIMARY KEY, b_id int);
CREATE b (id int PRIMARY KEY, c_id int);
CREATE c (id int PRIMARY KEY);
CREATE d (a int, b int);
...
CREATE  a (id int PRIMARY KEY);
CREATE  b (id int PRIMARY KEY, a_id int);
...
create innertab (id int8 primary key, dat1 int8);
...
create uniquetbl (f1 text unique);
...
drop table bigger_than_it_looks;
drop table simple;
