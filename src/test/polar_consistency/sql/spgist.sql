...
select count(*) from spgist_point_tbl where p<^'(1001,1001)';
select * from spgist_point_tbl where p~='(60,60)';
select * from spgist_point_tbl where p~='(40,40)';
select * from spgist_point_tbl where p~='(30,30)';
...
select count(*) from spgist_point_tbl where p<^'(1001,1001)';
select * from spgist_point_tbl where p~='(30,30)';
select * from spgist_point_tbl where p~='(1000,1000)';
select * from spgist_point_tbl where p~='(1001,1001)';
