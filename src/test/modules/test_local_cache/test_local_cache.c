...
extern PGDLLEXPORT void test_local_cache_write_worker(Datum main_arg);
extern PGDLLEXPORT void test_local_cache_read_worker(Datum main_arg);
extern PGDLLEXPORT void test_local_cache_flush_worker(Datum main_arg);
extern PGDLLEXPORT void test_local_cache_remove_worker(Datum main_arg);
