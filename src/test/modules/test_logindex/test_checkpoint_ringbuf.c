...
test_checkpoint_ringbuf(PG_FUNCTION_ARGS)
{
	...
	XLogRecPtr	old_bg_replayed_lsn = polar_get_bg_replayed_lsn(polar_logindex_redo_instance);
	int			used,
				ret;
	 ...
	 * ringbuf
	 */
	polar_reset_bg_replayed_lsn(polar_logindex_redo_instance, 0);
	...
	polar_advance_bg_replayed_lsn(polar_logindex_redo_instance, first_lsn + ringbuf.size / 3);
	...
	polar_advance_bg_replayed_lsn(polar_logindex_redo_instance, checkpoint.redo);
	...
	polar_reset_bg_replayed_lsn(polar_logindex_redo_instance, old_bg_replayed_lsn);
