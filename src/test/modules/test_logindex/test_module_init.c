...
static void
test_logindex_module_shmem_request(void)
{
...
static void
test_logindex_module_shmem_startup(void)
{
...
_PG_init(void)
{
	...
	shmem_request_hook = test_logindex_module_shmem_request;
	prev_shmem_startup_hook = shmem_startup_hook;
	shmem_startup_hook = test_logindex_module_shmem_startup;
}
