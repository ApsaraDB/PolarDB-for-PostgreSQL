...
test_logindex_bgwriter_main(Datum main_arg)
{
	...
	{
		int rc = WaitLatch(&MyProc->procLatch, WL_LATCH_SET | WL_TIMEOUT |
						   WL_POSTMASTER_DEATH, 100, PG_WAIT_EXTENSION);
...
test_logindex(PG_FUNCTION_ARGS)
{
	...
	polar_logindex_snapshot_init(logindex_snapshot, LSN_TEST_STEP, false);
