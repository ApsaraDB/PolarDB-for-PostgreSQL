...
#define MASKING_SCHEMA_NAME "polar_security"
...
/*
 * Definition of functions to get objectid of polar masking relations and indexes.
 */
...
#define MASKING_TEXTTONAME_FUNCID 407
#define MASKING_NAMETOTEXT_FUNCID 406
