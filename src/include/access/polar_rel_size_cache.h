...
extern void polar_record_rel_size(polar_rel_size_cache_t cache, XLogRecPtr lsn, RelFileLocator *rlocator, ForkNumber fork, BlockNumber rel_size);
extern void polar_record_rel_size_with_lock(polar_rel_size_cache_t cache, XLogRecPtr lsn, RelFileLocator *rlocator, ForkNumber fork, BlockNumber rel_size);
