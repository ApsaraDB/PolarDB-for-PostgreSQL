...
#define POLAR_MAX_NETWORK_STAT_SLOTS (MaxBackends + NUM_AUXILIARY_PROCS)

#define CHECK_NET_STAT_BACKENDID_VALID(backendid) (backendid >= 0 && backendid < POLAR_MAX_NETWORK_STAT_SLOTS)

#define POLAR_NET_STAT_BACKEND_INDEX() \
    (CHECK_NET_STAT_BACKENDID_VALID(MyProcNumber) ? MyProcNumber : -1)
