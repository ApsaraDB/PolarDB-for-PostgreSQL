...
extern PGDLLEXPORT bool pfs_force_mount;
extern PGDLLEXPORT bool localfs_mode;
extern PGDLLEXPORT bool polar_vfs_debug;
 ...
 * vfs_(p)write vfs_(p)read vfs_lseek vfs_fsync vfs_posix_fallocate, vfs_fallocate
 */
typedef void (*polar_vfs_env_hook_type) (polar_vfs_ops ops);
extern PGDLLEXPORT polar_vfs_env_hook_type polar_vfs_env_init_hook;
extern PGDLLEXPORT polar_vfs_env_hook_type polar_vfs_env_destroy_hook;

typedef void (*polar_vfs_file_hook_type) (const char *path, vfs_vfd *vfdp, polar_vfs_ops ops);
extern PGDLLEXPORT polar_vfs_file_hook_type polar_vfs_file_before_hook;
extern PGDLLEXPORT polar_vfs_file_hook_type polar_vfs_file_after_hook;

typedef void (*polar_vfs_io_hook_type) (vfs_vfd *vfdp, ssize_t ret, polar_vfs_ops ops);
extern PGDLLEXPORT polar_vfs_io_hook_type polar_vfs_io_before_hook;
extern PGDLLEXPORT polar_vfs_io_hook_type polar_vfs_io_after_hook;
