...
typedef enum BuiltinTrancheIds
{
	...
	LWTRANCHE_XLOG_BUFFER_IO,
	LWTRANCHE_LOGINDEX_MEM_TBL,
	LWTRANCHE_LOGINDEX_BLOOM_LRU,
	LWTRANCHE_LOGINDEX_HASH_LOCK,
	LWTRANCHE_LOGINDEX_MINI_TRANSACTION,
	LWTRANCHE_LOGINDEX_MINI_TRANSACTION_TBL,
	LWTRANCHE_LOGINDEX_IO,
	LWTRANCHE_FULLPAGE_FILE,
	LWTRANCHE_FULLPAGE_WRITE,
