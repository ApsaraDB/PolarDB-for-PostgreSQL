...
#define POLAR_MAX_LOCK_STAT_SLOTS (MaxBackends + NUM_AUXILIARY_PROCS)

#define CHECK_LOCK_STAT_BACKENDID_VALID(backendid) (backendid >= 0 && backendid < POLAR_MAX_LOCK_STAT_SLOTS)

#define POLAR_LOCK_STAT_BACKEND_INDEX() \
    (CHECK_LOCK_STAT_BACKENDID_VALID(MyProcNumber) ? MyProcNumber : -1)
