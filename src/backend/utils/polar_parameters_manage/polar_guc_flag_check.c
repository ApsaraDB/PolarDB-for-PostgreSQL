 ...
 */
void
polar_parameter_manage_check_flag(struct config_generic *guc_variable)
{
	...
	polar_parameter_manage_check_one(guc_variable);
}
...
#define HINT_MESSAGE "\n===========================Important===========================\n"                                                                                                                  \
	...
	if (!(guc->flags & (POLAR_GUC_IS_VISIBLE | POLAR_GUC_IS_INVISIBLE | POLAR_GUC_IS_CHANGEABLE | POLAR_GUC_IS_UNCHANGEABLE)))
		ereport(FATAL,
				(errcode(ERRCODE_INVALID_PARAMETER_VALUE),
				 errmsg("\nPlease mask %s POLAR_GUC_IS_VISIBLE or POLAR_GUC_IS_INVISIBLE and POLAR_GUC_IS_CHANGEABLE or POLAR_GUC_IS_UNCHANGEABLE", guc->name),
	...
	if (!(guc->flags & (POLAR_GUC_IS_CHANGEABLE | POLAR_GUC_IS_UNCHANGEABLE)))
		ereport(FATAL,
				(errcode(ERRCODE_INVALID_PARAMETER_VALUE),
				 errmsg("\nPlease mask %s POLAR_GUC_IS_CHANGEABLE or POLAR_GUC_IS_UNCHANGEABLE", guc->name),
				 errhint(HINT_MESSAGE)));
}
