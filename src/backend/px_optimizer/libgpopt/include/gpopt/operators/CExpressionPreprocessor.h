...
private:
	...
	// rewrite rownum
	static CExpression *PexprRewriteRowNum(CMemoryPool *mp, CExpression *pexpr);
	...
	/* POLAR px */
	static CExpression *PexprPartitionWiseJoin(CMemoryPool *mp,
											   CExpression *expr,
	...
	static CTableDescriptor *MakeTableDescForPart(CMemoryPool *mp,
												  const IMDRelation *part,
												  CTableDescriptor *root_desc);
...
public:
	...
	static CExpression *PexprPreprocess(
		...
		CColRefArray *pdrgpcrPrpp = nullptr,
		CColRefSet *pcrsRequiredPrpp = nullptr,
		COrderSpec *posRequired = nullptr);
