...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CCostModelPolarDB
//
//	@doc:
//		Ctor
//
//---------------------------------------------------------------------------
CCostModelPolarDB::CCostModelPolarDB(CMemoryPool *mp, ULONG ulSegments,
							   CCostModelParamsPolarDB *pcp)
	: m_mp(mp), m_num_of_segments(ulSegments)
{
	...
	if (nullptr == pcp)
	{
		m_cost_model_params = GPOS_NEW(mp) CCostModelParamsPolarDB(mp);
	}
	else
	{
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::DRowsPerHost
//
//	@doc:
...
//---------------------------------------------------------------------------
CDouble
CCostModelPolarDB::DRowsPerHost(CDouble dRowsTotal) const
{
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostTupleProcessing
//
//	@doc:
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostTupleProcessing(DOUBLE rows, DOUBLE width,
									ICostModelParams *pcp)
{
	GPOS_ASSERT(nullptr != pcp);

	const CDouble dTupDefaultProcCostUnit =
		pcp->PcpLookup(CCostModelParamsPolarDB::EcpTupDefaultProcCostUnit)->Get();
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostScanOutput
//
//	@doc:
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostScanOutput(CMemoryPool *,  // mp
							   ...
							   ICostModelParams *pcp)
{
	...
	const CDouble dOutputTupCostUnit =
		pcp->PcpLookup(CCostModelParamsPolarDB::EcpOutputTupCostUnit)->Get();
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostUnary(CMemoryPool *mp, CExpressionHandle &exprhdl,
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostSpooling
//
//	@doc:
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostSpooling(CMemoryPool *mp, CExpressionHandle &exprhdl,
							 const SCostingInfo *pci, ICostModelParams *pcp)
{
	GPOS_ASSERT(nullptr != pci);
	GPOS_ASSERT(nullptr != pcp);
	...
	const CDouble dMaterializeCostUnit =
		pcp->PcpLookup(CCostModelParamsPolarDB::EcpMaterializeCostUnit)->Get();
...
//---------------------------------------------------------------------------
BOOL
CCostModelPolarDB::FUnary(COperator::EOperatorId op_id)
{
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostChildren
//
//	@doc:
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostChildren(CMemoryPool *mp, CExpressionHandle &exprhdl,
							 const SCostingInfo *pci, ICostModelParams *pcp)
{
	GPOS_ASSERT(nullptr != pci);
	GPOS_ASSERT(nullptr != pcp);
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostMaxChild
//
//	@doc:
...
CCost
CCostModelPolarDB::CostMaxChild(CMemoryPool *, CExpressionHandle &,
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostCTEProducer
//
//	@doc:
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostCTEProducer(CMemoryPool *mp, CExpressionHandle &exprhdl,
								...
								const SCostingInfo *pci)
{
	...
	const CDouble dMaterializeCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpMaterializeCostUnit)
			->Get();
	GPOS_ASSERT(0 < dMaterializeCostUnit);
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostCTEConsumer
//
//	@doc:
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostCTEConsumer(CMemoryPool *,	// mp
								CExpressionHandle &
#ifdef GPOS_DEBUG
									exprhdl
#endif	// GPOS_DEBUG
								...
								const SCostingInfo *pci)
{
	...
	const CDouble dInitScan =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpInitScanFactor)
			->Get();
	const CDouble dTableScanCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpTableScanCostUnit)
			->Get();
	const CDouble dOutputTupCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpOutputTupCostUnit)
			->Get();
	GPOS_ASSERT(0 < dOutputTupCostUnit);
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostConstTableGet
//
//	@doc:
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostConstTableGet(CMemoryPool *,  // mp
								  CExpressionHandle &
#ifdef GPOS_DEBUG
									  exprhdl
#endif	// GPOS_DEBUG
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostDML(CMemoryPool *mp, CExpressionHandle &exprhdl,
						const CCostModelPolarDB *pcmgpdb, const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
	GPOS_ASSERT(nullptr != pci);
	...
	const CDouble dTupUpdateBandwidth =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpTupUpdateBandwith)
			->Get();
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostScalarAgg
//
//	@doc:
//		Cost of scalar agg
//
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostScalarAgg(CMemoryPool *mp, CExpressionHandle &exprhdl,
							  const CCostModelPolarDB *pcmgpdb,
							  const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
	...
	const CDouble dHashAggInputTupWidthCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpHashAggInputTupWidthCostUnit)
			->Get();
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostStreamAgg
//
//	@doc:
//		Cost of stream agg
//
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostStreamAgg(CMemoryPool *mp, CExpressionHandle &exprhdl,
							  const CCostModelPolarDB *pcmgpdb,
							  const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
	...
	const CDouble dHashAggOutputTupWidthCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpHashAggOutputTupWidthCostUnit)
			->Get();
	const CDouble dTupDefaultProcCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpTupDefaultProcCostUnit)
			->Get();
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostSequence
//
//	@doc:
//		Cost of sequence
//
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostSequence(CMemoryPool *mp, CExpressionHandle &exprhdl,
							 const CCostModelPolarDB *pcmgpdb,
							 const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostSort(CMemoryPool *mp, CExpressionHandle &exprhdl,
						 const CCostModelPolarDB *pcmgpdb, const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
	GPOS_ASSERT(nullptr != pci);
	...
	const CDouble dSortTupWidthCost =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpSortTupWidthCostUnit)
			->Get();
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostTVF(CMemoryPool *,	// mp
						CExpressionHandle &
#ifdef GPOS_DEBUG
							exprhdl
#endif	// GPOS_DEBUG
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostUnionAll
//
//	@doc:
//		Cost of UnionAll
//
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostUnionAll(CMemoryPool *mp, CExpressionHandle &exprhdl,
							 const CCostModelPolarDB *pcmgpdb,
							 const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostHashAgg(CMemoryPool *mp, CExpressionHandle &exprhdl,
							const CCostModelPolarDB *pcmgpdb,
							const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
	...
	const CDouble dHashAggInputTupColumnCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpHashAggInputTupColumnCostUnit)
			->Get();
	const CDouble dHashAggInputTupWidthCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpHashAggInputTupWidthCostUnit)
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostHashJoin
//
//	@doc:
//		Cost of hash join
//
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostHashJoin(CMemoryPool *mp, CExpressionHandle &exprhdl,
							 const CCostModelPolarDB *pcmgpdb,
							 const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
	...
	const CDouble dHJHashTableInitCostFactor =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpHJHashTableInitCostFactor)
			->Get();
	const CDouble dHJHashTableColumnCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpHJHashTableColumnCostUnit)
			->Get();
	const CDouble dHJHashTableWidthCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpHJHashTableWidthCostUnit)
			->Get();
	const CDouble dJoinFeedingTupColumnCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpJoinFeedingTupColumnCostUnit)
			->Get();
	const CDouble dJoinFeedingTupWidthCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpJoinFeedingTupWidthCostUnit)
			->Get();
	const CDouble dHJHashingTupWidthCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpHJHashingTupWidthCostUnit)
			->Get();
	const CDouble dJoinOutputTupCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpJoinOutputTupCostUnit)
			->Get();
	const CDouble dHJSpillingMemThreshold =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpHJSpillingMemThreshold)
			->Get();
	const CDouble dHJFeedingTupColumnSpillingCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(
				CCostModelParamsPolarDB::EcpHJFeedingTupColumnSpillingCostUnit)
			->Get();
	const CDouble dHJFeedingTupWidthSpillingCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(
				CCostModelParamsPolarDB::EcpHJFeedingTupWidthSpillingCostUnit)
			->Get();
	const CDouble dHJHashingTupWidthSpillingCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(
				CCostModelParamsPolarDB::EcpHJHashingTupWidthSpillingCostUnit)
			->Get();
	const CDouble dPenalizeHJSkewUpperLimit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpPenalizeHJSkewUpperLimit)
			->Get();
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostMergeJoin
//
//	@doc:
//		Cost of merge join
//
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostMergeJoin(CMemoryPool *mp, CExpressionHandle &exprhdl,
							  const CCostModelPolarDB *pcmgpdb,
							  const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
	...
	const CDouble dFilterColCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpFilterColCostUnit)
			->Get();
	const CDouble dOutputTupCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpOutputTupCostUnit)
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostIndexNLJoin
//
//	@doc:
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostIndexNLJoin(CMemoryPool *mp, CExpressionHandle &exprhdl,
								const CCostModelPolarDB *pcmgpdb,
								const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
	...
	const CDouble dIndexJoinAllowedRiskThreshold =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpIndexJoinAllowedRiskThreshold)
			->Get();
	BOOL fInnerJoin =
		COperator::EopPhysicalInnerIndexNLJoin == exprhdl.Pop()->Eopid();
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostNLJoin(CMemoryPool *mp, CExpressionHandle &exprhdl,
						   const CCostModelPolarDB *pcmgpdb,
						   const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
	...
	const CDouble dNLJFactor =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpNLJFactor)
			->Get();
	...
	if (dRisk > dPenalization)
	{
		const CDouble dIndexJoinAllowedRiskThreshold =
			pcmgpdb->GetCostModelParams()
				->PcpLookup(
					CCostModelParamsPolarDB::EcpIndexJoinAllowedRiskThreshold)
				->Get();
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostMotion(CMemoryPool *mp, CExpressionHandle &exprhdl,
						   const CCostModelPolarDB *pcmgpdb,
						   const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
	...
	if (COperator::EopPhysicalMotionBroadcast == op_id)
	{
		...
		dSendCostUnit =
			pcmgpdb->GetCostModelParams()
				->PcpLookup(CCostModelParamsPolarDB::EcpBroadcastSendCostUnit)
				->Get();
		dRecvCostUnit =
			pcmgpdb->GetCostModelParams()
				->PcpLookup(CCostModelParamsPolarDB::EcpBroadcastRecvCostUnit)
				->Get();
			 ...
			 COperator::EopPhysicalMotionRoutedDistribute == op_id)
	{
		dSendCostUnit =
			pcmgpdb->GetCostModelParams()
				->PcpLookup(CCostModelParamsPolarDB::EcpRedistributeSendCostUnit)
				->Get();
		dRecvCostUnit =
			pcmgpdb->GetCostModelParams()
				->PcpLookup(CCostModelParamsPolarDB::EcpRedistributeRecvCostUnit)
				->Get();
		...
		if (CDistributionSpec::EdtHashedNoOp == pds->Edt())
		{
			...
			dSendCostUnit =
				pcmgpdb->GetCostModelParams()
					->PcpLookup(CCostModelParamsPolarDB::EcpNoOpCostUnit)
					->Get();
			dRecvCostUnit =
				pcmgpdb->GetCostModelParams()
					->PcpLookup(CCostModelParamsPolarDB::EcpNoOpCostUnit)
	...
	else if (COperator::EopPhysicalMotionGather == op_id)
	{
		dSendCostUnit =
			pcmgpdb->GetCostModelParams()
				->PcpLookup(CCostModelParamsPolarDB::EcpGatherSendCostUnit)
				->Get();
		dRecvCostUnit =
			pcmgpdb->GetCostModelParams()
				->PcpLookup(CCostModelParamsPolarDB::EcpGatherRecvCostUnit)
				->Get();
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostSequenceProject
//
//	@doc:
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostSequenceProject(CMemoryPool *mp, CExpressionHandle &exprhdl,
									const CCostModelPolarDB *pcmgpdb,
									const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
...
//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostIndexScan
//
//	@doc:
//		Cost of index scan
//
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostIndexScan(CMemoryPool *,  // mp
							  ...
							  const SCostingInfo *pci)
{
	...
	const CDouble dIndexFilterCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpIndexFilterCostUnit)
			->Get();
	const CDouble dIndexScanTupCostUnit =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpIndexScanTupCostUnit)
			->Get();
	const CDouble dIndexScanTupRandomFactor =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpIndexScanTupRandomFactor)
			->Get();
...
CCost
CCostModelPolarDB::CostIndexOnlyScan(CMemoryPool *mp GPOS_UNUSED,	  // mp
								  CExpressionHandle &exprhdl,	  //exprhdl
								  const CCostModelPolarDB *pcmgpdb,  // pcmgpdb
...
/* POLAR px */
CCost
CCostModelPolarDB::CostShareIndexScan(CMemoryPool *,  // mp
							  CExpressionHandle &exprhdl,
							  const CCostModelPolarDB *pcmgpdb,
							  const SCostingInfo *pci)
{
	...
	COperator *pop = exprhdl.Pop();
	COperator::EOperatorId op_id = pop->Eopid();
	GPOS_ASSERT(COperator::EopPhysicalShareIndexScan == op_id ||
	...
	const CDouble dShareIndexScanFactor = 
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpPolarShareIndexScanFactor)
			->Get();
	GPOS_ASSERT(0 < dShareIndexScanFactor);

	GPOS_ASSERT(0 < dIndexFilterCostUnit);
	GPOS_ASSERT(0 < dIndexScanTupCostUnit);
	GPOS_ASSERT(0 < dIndexScanTupRandomFactor);

	CDouble dRowsIndex = pci->Rows() * pcmgpdb->UlHosts();

	ULONG ulIndexKeys = 1;
	if (COperator::EopPhysicalShareIndexScan == op_id)
	{
		ulIndexKeys =
			CPhysicalShareIndexScan::PopConvert(pop)->Pindexdesc()->Keys();
	}
	else
	{
		ulIndexKeys =
			CPhysicalDynamicShareIndexScan::PopConvert(pop)->Pindexdesc()->Keys();
	}
...
CCost
CCostModelPolarDB::CostBitmapTableScan(CMemoryPool *mp, CExpressionHandle &exprhdl,
									const CCostModelPolarDB *pcmgpdb,
									const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
	...
	CDouble dInitRebind =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpBitmapScanRebindCost)
			->Get();
	...
	else
	{
		...
		CDouble dNDVThreshold =
			pcmgpdb->GetCostModelParams()
				->PcpLookup(CCostModelParamsPolarDB::EcpBitmapNDVThreshold)
				->Get();
		...
		else
		{
			...
			CDouble dBitmapIO =
				pcmgpdb->GetCostModelParams()
					->PcpLookup(CCostModelParamsPolarDB::EcpBitmapIOCostSmallNDV)
					->Get();
			...
			CDouble c3_dBitmapPageCost =
				pcmgpdb->GetCostModelParams()
					->PcpLookup(CCostModelParamsPolarDB::EcpBitmapPageCost)
					->Get();
...
CCost
CCostModelPolarDB::CostBitmapSmallNDV(const CCostModelPolarDB *pcmgpdb,
								   const SCostingInfo *pci, CDouble dNDV)
{
	...
	CDouble dBitmapPageCost =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpBitmapPageCostSmallNDV)
			->Get();
...
CCost
CCostModelPolarDB::CostBitmapLargeNDV(const CCostModelPolarDB *pcmgpdb,
								   const SCostingInfo *pci, CDouble dNDV)
{
	const DOUBLE rows = pci->Rows();
	const DOUBLE width = pci->Width();
	...
	CDouble dBitmapIO =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpBitmapIOCostLargeNDV)
			->Get();
	CDouble dBitmapPageCost =
		pcmgpdb->GetCostModelParams()
			->PcpLookup(CCostModelParamsPolarDB::EcpBitmapPageCostLargeNDV)
			->Get();
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostScan(CMemoryPool *,	 // mp
						 CExpressionHandle &exprhdl,
						 const CCostModelPolarDB *pcmgpdb, const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
...
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostShareScan
	(
	CMemoryPool *, // mp
	CExpressionHandle &exprhdl,
	const CCostModelPolarDB *pcmgpdb,
	...
	)
{
	...
	COperator *pop = exprhdl.Pop();
	GPOS_ASSERT(pop->Eopid() == COperator::EopPhysicalTableShareScan);

	const CDouble dInitScan = pcmgpdb->GetCostModelParams()->PcpLookup(CCostModelParamsPolarDB::EcpInitScanFactor)->Get();
	const CDouble dTableWidth = CPhysicalScan::PopConvert(pop)->PstatsBaseTable()->Width();

	// Get total rows for each host to scan
	const CDouble dTableScanCostUnit = pcmgpdb->GetCostModelParams()->PcpLookup(CCostModelParamsPolarDB::EcpTableScanCostUnit)->Get();
	GPOS_ASSERT(0 < dTableScanCostUnit);

	// POLAR px: scan factor
	const CDouble dTableShareScanFactor = pcmgpdb->GetCostModelParams()->PcpLookup(CCostModelParamsPolarDB::EcpPolarTableShareScanFactor)->Get();
	GPOS_ASSERT(0 < dTableShareScanFactor);

	return CCost(pci->NumRebinds() * dTableShareScanFactor *
			(dInitScan + pci->Rows() * pcmgpdb->UlHosts() * dTableWidth * dTableScanCostUnit));
}


//---------------------------------------------------------------------------
//	@function:
//		CCostModelPolarDB::CostFilter
//
//	@doc:
//		Cost of filter
//
//---------------------------------------------------------------------------
CCost
CCostModelPolarDB::CostFilter(CMemoryPool *mp, CExpressionHandle &exprhdl,
						   const CCostModelPolarDB *pcmgpdb,
						   const SCostingInfo *pci)
{
	GPOS_ASSERT(nullptr != pcmgpdb);
	...
	const SCostingInfo *pci) const
{
	...
	switch (op_id)
	{
		...
		{
			return CostShareScan(m_mp, exprhdl, this, pci);
		}
		...
		{
			return CostShareIndexScan(m_mp, exprhdl, this, pci);
		}
