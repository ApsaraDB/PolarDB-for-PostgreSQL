...
const CDouble CCostModelParamsGPDB::DPolarTableShareScanFactor(1.0);

// POLAR px: share index scan factor
const CDouble CCostModelParamsGPDB::DPolarShareIndexScanFactor(1.0);
...
CCostModelParamsGPDB::CCostModelParamsGPDB(CMemoryPool *mp) : m_mp(mp)
{
	...
	// POLAR px
	m_rgpcp[EcpPolarTableShareScanFactor] = GPOS_NEW(mp) SCostParam(
		EcpPolarTableShareScanFactor, DPolarTableShareScanFactor,
		DPolarTableShareScanFactor - 0.0, DPolarTableShareScanFactor + 0.0);
	m_rgpcp[EcpPolarShareIndexScanFactor] = GPOS_NEW(mp) SCostParam(
		EcpPolarShareIndexScanFactor, DPolarShareIndexScanFactor,
		DPolarShareIndexScanFactor - 0.0, DPolarShareIndexScanFactor + 0.0);
