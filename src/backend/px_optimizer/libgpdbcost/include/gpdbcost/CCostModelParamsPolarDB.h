...
//
//	@filename:
//		CCostModelParamsPolarDB.h
//
//	@doc:
//		Parameters in PolarDB cost model
//---------------------------------------------------------------------------
#ifndef PolarDBCOST_CCostModelParamsPolarDB_H
#define PolarDBCOST_CCostModelParamsPolarDB_H
...
namespace gpopt
{
	...
	//---------------------------------------------------------------------------
	//	@class:
	//		CCostModelParamsPolarDB
	//
	//	@doc:
	//		Parameters in PolarDB cost model
	//
	//---------------------------------------------------------------------------
	class CCostModelParamsPolarDB : public ICostModelParams
	{
		...
		public:
			...
			enum ECostParam
			{
				...
				/* POLAR px */
				EcpPolarTableShareScanFactor, 	// table share scan factor
				EcpPolarShareIndexScanFactor, 	// share index scan factor
		...
		private:
			...
			static const CDouble DPolarTableShareScanFactor;
			// POLAR px: share index scan factor
			static const CDouble DPolarShareIndexScanFactor;
		...
		public:
			...
			// ctor
			explicit
			CCostModelParamsPolarDB(CMemoryPool *mp);
	...
	}; // class CCostModelParamsPolarDB

}

#endif // !PolarDBCOST_CCostModelParamsPolarDB_H
