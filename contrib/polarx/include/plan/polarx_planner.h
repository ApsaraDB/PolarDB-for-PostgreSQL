 ...
 *
 * IDENTIFICATION
 *        contrib/polarx/include/plan/polarx_planner.h
 *
 *-------------------------------------------------------------------------
 */
#ifndef POLARX_PLANNER_H
#define POLARX_PLANNER_H
...
extern List *makeCustomScanVarTargetlistBasedTargetEntryList(List *targetEntryList);

#endif   /* POLARX_PLANNER_H */
