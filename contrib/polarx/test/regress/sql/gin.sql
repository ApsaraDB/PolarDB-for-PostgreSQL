...
execute polarx_direct('datanode_1', 'select gin_clean_pending_list(''gin_test_idx'')>10 as many');
execute polarx_direct('datanode_2' , 'select gin_clean_pending_list(''gin_test_idx'')>10 as many');
