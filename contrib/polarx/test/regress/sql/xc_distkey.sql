...
create table ch_tab(a char) with(dist_type=modulo, dist_col=a);
insert into ch_tab values('a');
select hashchar('a');


create table nm_tab(a name) with(dist_type=modulo, dist_col=a);
insert into nm_tab values('abbas');
select hashname('abbas');

create table nu_tab(a numeric(10,5)) with(dist_type=modulo, dist_col=a);
...
create table tx_tab(a text) with(dist_type=modulo, dist_col=a);
...
create table vc_tab(a varchar(255)) with(dist_type=modulo, dist_col=a);
...
create table f8_tab(a float8) with(dist_type=modulo, dist_col=a);
...
create table f4_tab(a float4) with(dist_type=modulo, dist_col=a);
...
create table i8_tab(a int8) with(dist_type=modulo, dist_col=a);
...
create table i2_tab(a int2) with(dist_type=modulo, dist_col=a);
...
create table oid_tab(a oid) with(dist_type=modulo, dist_col=a);
...
create table i4_tab(a int4) with(dist_type=modulo, dist_col=a);
...
create table bo_tab(a bool) with(dist_type=modulo, dist_col=a);
...
create table bpc_tab(a char(35)) with(dist_type=modulo, dist_col=a);
...
create table byta_tab(a bytea) with(dist_type=modulo, dist_col=a);
...
create table tim_tab(a time) with(dist_type=modulo, dist_col=a);
...
create table timtz_tab(a time with time zone) with(dist_type=modulo, dist_col=a);
...
create table ts_tab(a timestamp) with(dist_type=modulo, dist_col=a);
...
create table in_tab(a interval) with(dist_type=modulo, dist_col=a);
...
create table cash_tab(a money) with(dist_type=modulo, dist_col=a);
...
create table atim_tab(a abstime) with(dist_type=modulo, dist_col=a);
...
create table rtim_tab(a reltime) with(dist_type=modulo, dist_col=a);
...
create table date_tab(a date) with(dist_type=modulo, dist_col=a);
...
create table tstz_tab(a timestamp with time zone) with(dist_type=modulo, dist_col=a);
...
create table tstz_tab_h(a timestamp with time zone) with(dist_type=hash, dist_col=a);
...
create table my_rr_tab(a integer, b varchar(100)) with(dist_type=roundrobin);
