...
GRANT ALL ON FOREIGN SERVER cluster_server to regress_user1;
GRANT ALL ON FOREIGN SERVER cluster_server to regress_user2;
GRANT ALL ON FOREIGN SERVER cluster_server to regress_user3;
GRANT ALL ON FOREIGN SERVER cluster_server to regress_user4;
GRANT ALL ON FOREIGN SERVER cluster_server to regress_user5;
...
REVOKE ALL ON FOREIGN SERVER cluster_server from regress_user1;
REVOKE ALL ON FOREIGN SERVER cluster_server from regress_user2;
REVOKE ALL ON FOREIGN SERVER cluster_server from regress_user3;
REVOKE ALL ON FOREIGN SERVER cluster_server from regress_user4;
REVOKE ALL ON FOREIGN SERVER cluster_server from regress_user5;
