...
GRANT ALL ON FOREIGN SERVER cluster_server to regress_alter_user3;
GRANT ALL ON FOREIGN SERVER cluster_server to regress_alter_user2;
GRANT ALL ON FOREIGN SERVER cluster_server to regress_alter_user1;
...
REVOKE ALL ON FOREIGN SERVER cluster_server from regress_alter_user3;
REVOKE ALL ON FOREIGN SERVER cluster_server from regress_alter_user2;
REVOKE ALL ON FOREIGN SERVER cluster_server from regress_alter_user1;
