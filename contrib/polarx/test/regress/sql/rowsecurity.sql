...
GRANT ALL ON FOREIGN SERVER cluster_server to regress_rls_alice;
GRANT ALL ON FOREIGN SERVER cluster_server to regress_rls_bob;
GRANT ALL ON FOREIGN SERVER cluster_server to regress_rls_carol;
GRANT ALL ON FOREIGN SERVER cluster_server to regress_rls_dave;
GRANT ALL ON FOREIGN SERVER cluster_server to regress_rls_exempt_user;
...
INSERT INTO document VALUES    ( 3, 22, 2, 'regress_rls_bob', 'my science fiction');
INSERT INTO document VALUES    ( 4, 44, 1, 'regress_rls_bob', 'my first manga');
INSERT INTO document VALUES    ( 5, 44, 2, 'regress_rls_bob', 'my second manga');
INSERT INTO document VALUES    ( 6, 22, 1, 'regress_rls_carol', 'great science fiction');
INSERT INTO document VALUES    ( 7, 33, 2, 'regress_rls_carol', 'great technology book');
INSERT INTO document VALUES    ( 8, 44, 1, 'regress_rls_carol', 'great manga');
INSERT INTO document VALUES    ( 9, 22, 1, 'regress_rls_dave', 'awesome science fiction');
INSERT INTO document VALUES    (10, 33, 2, 'regress_rls_dave', 'awesome technology book');
...
GRANT ALL ON b1 TO regress_rls_carol;
...
\set VERBOSITY default
REVOKE ALL ON FOREIGN SERVER cluster_server from regress_rls_alice;
REVOKE ALL ON FOREIGN SERVER cluster_server from regress_rls_bob;
REVOKE ALL ON FOREIGN SERVER cluster_server from regress_rls_carol;
REVOKE ALL ON FOREIGN SERVER cluster_server from regress_rls_dave;
REVOKE ALL ON FOREIGN SERVER cluster_server from regress_rls_exempt_user;
