/*-------------------------------------------------------------------------
 *
 * pg_regress_x --- polarx regression test driver
 *
...
/*
 * In PolartDB_X, a regression test check is run on 2 Coordinators
 ...
 */
static bool 	multi_node_test = true;
...
const char *type_coordinator = "coordinator";
const char *type_datanode = "datanode";
...
/* Additional PIDs for POLARDBX temporary nodes */
...
set_node_config_file(PGXCNodeTypeNum node)
{
	 ...
	 */
	fputs("max_prepared_transactions = 10000\n", pg_conf);
	...
	//fputs(buf, pg_conf);
	fputs("gc_interval = 1000000\n", pg_conf);

	/* log on */
	fputs("log_destination = 'stderr'\n", pg_conf);
 ...
 */
static void
setup_connection_information(const char *database)
{
	header(_("setting connection information"));

	/* -----coordinator 1 ------- */
    psql_command_node(database, PGXC_COORD_1, "CREATE EXTENSION polarx;");
	/* node info in Coordinator 1 */
	psql_command_node(database, PGXC_COORD_1, "CREATE SERVER %s TYPE 'C' FOREIGN DATA WRAPPER polarx OPTIONS (host 'localhost',"
			"port '%d', nodeis_primary 'false', nodeis_preferred 'false', node_cluster_name 'cluster_server', nodeis_local 'true', node_id '1');",
			(char *)get_node_name(PGXC_COORD_1), get_port_number(PGXC_COORD_1));
	/* Remote Coordinator on Coordinator 1 */
    psql_command_node(database, PGXC_COORD_1, "CREATE SERVER %s TYPE 'C' FOREIGN DATA WRAPPER polarx OPTIONS (host 'localhost',"
			"port '%d', nodeis_primary 'false', nodeis_preferred 'false', node_cluster_name 'cluster_server', nodeis_local 'false', node_id '2');",
			(char *)get_node_name(PGXC_COORD_2), get_port_number(PGXC_COORD_2));
	/* Datanodes on Coordinator 1 */
    psql_command_node(database, PGXC_COORD_1, "CREATE SERVER %s TYPE 'D' FOREIGN DATA WRAPPER polarx OPTIONS (host 'localhost',"
			"port '%d', nodeis_primary 'false', nodeis_preferred 'false', node_cluster_name 'cluster_server', nodeis_local 'false', node_id '3');",
			(char *)get_node_name(PGXC_DATANODE_1), get_port_number(PGXC_DATANODE_1));

	psql_command_node(database, PGXC_COORD_1, "CREATE SERVER %s TYPE 'D' FOREIGN DATA WRAPPER polarx OPTIONS (host 'localhost',"
			"port '%d', nodeis_primary 'false', nodeis_preferred 'false', node_cluster_name 'cluster_server', nodeis_local 'false', node_id '4');",
	...
	psql_command_node(database, PGXC_COORD_2, "CREATE SERVER %s TYPE 'C' FOREIGN DATA WRAPPER polarx OPTIONS (host 'localhost',"
			"port '%d', nodeis_primary 'false', nodeis_preferred 'false', node_cluster_name 'cluster_server', nodeis_local 'false', node_id '1');",
			(char *)get_node_name(PGXC_COORD_1), get_port_number(PGXC_COORD_1));
	/* node info in Coordinator 2 */
    psql_command_node(database, PGXC_COORD_2, "CREATE SERVER %s TYPE 'C' FOREIGN DATA WRAPPER polarx OPTIONS (host 'localhost',"
			"port '%d', nodeis_primary 'false', nodeis_preferred 'false', node_cluster_name 'cluster_server', nodeis_local 'true', node_id '2');",
			(char *)get_node_name(PGXC_COORD_2), get_port_number(PGXC_COORD_2));
	/* Datanodes on Coordinator 2 */
    psql_command_node(database, PGXC_COORD_2, "CREATE SERVER %s TYPE 'D' FOREIGN DATA WRAPPER polarx OPTIONS (host 'localhost',"
			"port '%d', nodeis_primary 'false', nodeis_preferred 'false', node_cluster_name 'cluster_server', nodeis_local 'false', node_id '3');",
			(char *)get_node_name(PGXC_DATANODE_1), get_port_number(PGXC_DATANODE_1));
	...
	/* -----datanode 1 ------- */
    psql_command_node(database, PGXC_DATANODE_1, "CREATE EXTENSION polarx;");

	/* Remote Coordinator 1 on Datanode 1 */
	psql_command_node(database, PGXC_DATANODE_1, "CREATE SERVER %s TYPE 'C' FOREIGN DATA WRAPPER polarx OPTIONS (host 'localhost',"
			"port '%d', nodeis_primary 'false', nodeis_preferred 'false', node_cluster_name 'cluster_server', nodeis_local 'false', node_id '1');",
			(char *)get_node_name(PGXC_COORD_1), get_port_number(PGXC_COORD_1));
    ...
    psql_command_node(database, PGXC_DATANODE_1, "CREATE SERVER %s TYPE 'D' FOREIGN DATA WRAPPER polarx OPTIONS (host 'localhost',"
			"port '%d', nodeis_primary 'true', nodeis_preferred 'false', node_cluster_name 'cluster_server', nodeis_local 'true', node_id '3');",
			(char *)get_node_name(PGXC_DATANODE_1), get_port_number(PGXC_DATANODE_1));

	/* Remote Datanode 2 on Datanode 1 */
	psql_command_node(database, PGXC_DATANODE_1, "CREATE SERVER %s TYPE 'D' FOREIGN DATA WRAPPER polarx OPTIONS (host 'localhost',"
			"port '%d', nodeis_primary 'true', nodeis_preferred 'false', node_cluster_name 'cluster_server', nodeis_local 'false', node_id '4');",
			(char *)get_node_name(PGXC_DATANODE_2), get_port_number(PGXC_DATANODE_2));
	...
	psql_command_node(database, PGXC_DATANODE_2, "CREATE SERVER %s TYPE 'C' FOREIGN DATA WRAPPER polarx OPTIONS (host 'localhost',"
			"port '%d', nodeis_primary 'false', nodeis_preferred 'false', node_cluster_name 'cluster_server', nodeis_local 'false', node_id '1');",
			(char *)get_node_name(PGXC_COORD_1), get_port_number(PGXC_COORD_1));
    ...
    psql_command_node(database, PGXC_DATANODE_2, "CREATE SERVER %s TYPE 'D' FOREIGN DATA WRAPPER polarx OPTIONS (host 'localhost',"
			"port '%d', nodeis_primary 'true', nodeis_preferred 'false', node_cluster_name 'cluster_server', nodeis_local 'false', node_id '3');",
			(char *)get_node_name(PGXC_DATANODE_1), get_port_number(PGXC_DATANODE_1));

	/* node info in Datanode 2 */
	psql_command_node(database, PGXC_DATANODE_2, "CREATE SERVER %s TYPE 'D' FOREIGN DATA WRAPPER polarx OPTIONS (host 'localhost',"
			"port '%d', nodeis_primary 'true', nodeis_preferred 'false', node_cluster_name 'cluster_server', nodeis_local 'true', node_id '4');",
			(char *)get_node_name(PGXC_DATANODE_2), get_port_number(PGXC_DATANODE_2));
...
#error Platform has no means to secure the test installation.
		 ...
		 */
		header(_("starting polardb-for-postgresql cluster"));
...
#define ULONGPID(x) (unsigned long) (x)
	...
	//			get_port_number(PGXC_GTM), ULONGPID(get_node_pid(PGXC_GTM)));
		...
		setup_connection_information("postgres");
	}
	else
	{
		/*
	...
	if (!use_existing)
	{
		for (sl = dblist; sl; sl = sl->next)
		{
		    ...
		    setup_connection_information(sl->str);
			//psql_command_node(sl->str, PGXC_COORD_1, "CREATE EXTENSION polarx;");
			//psql_command_node(sl->str, PGXC_COORD_1, "CREATE SERVER cluster_server FOREIGN DATA WRAPPER polarx;");
		}
		for (sl = extraroles; sl; sl = sl->next)
