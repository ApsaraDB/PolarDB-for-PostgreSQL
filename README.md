...
Edit `$HOME/polardb/polardb_paxos.conf`, if it exists, to include the [content](/doc/polardb/deployment.md#cluster-configuration-format). If this file does not exist, then create the file `$HOME/polardb/polardb_paxos.conf` and write the [content](/doc/polardb/deployment.md#cluster-configuration-format).
