...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="依赖安装" tabindex="-1"><a class="header-anchor" href="#依赖安装" aria-hidden="true">#</a> 依赖安装</h3><p>在 PolarDB for PostgreSQL 源码库根目录的 <code>deps/</code> 子目录下，放置了在各个 Linux 发行版上编译安装 PolarDB 和 PFS 需要运行的所有依赖。因此，首先需要克隆 PolarDB 的源码库。</p>`,16),E={href:"https://github.com/ApsaraDB/PolarDB-for-PostgreSQL",target:"_blank",rel:"noopener noreferrer"},N=s("code",null,"POLARDB_11_STABLE",-1),y={href:"https://gitee.com/mirrors/PolarDB-for-PostgreSQL",target:"_blank",rel:"noopener noreferrer"},R=s("div",{class:"language-bash","data-ext":"sh"},[s("pre",{class:"language-bash"},[s("code",null,[s("span",{class:"token function"},"sudo"),n(" yum "),s("span",{class:"token function"},"install"),n(),s("span",{class:"token parameter variable"},"-y"),n(),s("span",{class:"token function"},"git"),n(`
...
`)])])],-1),P=p(`<p>源码下载完毕后，使用 <code>sudo</code> 执行 <code>deps/</code> 目录下的相应脚本 <code>deps-***.sh</code> 自动完成所有的依赖安装。比如：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> PolarDB-for-PostgreSQL
<span class="token function">sudo</span> ./deps/deps-centos7.sh
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,2);function w(L,O){const e=o("ExternalLinkIcon"),i=o("CodeGroupItem"),t=o("CodeGroup");return c(),d("div",null,[v,u,s("p",null,[n("DockerHub 上已有构建完毕的开发镜像 "),s("a",b,[k,a(e)]),n(" 可供直接使用（支持 "),g,n(" 和 "),h,n(" 两种架构）。")]),s("p",null,[n("另外，我们也提供了构建上述开发镜像的 Dockerfile，从 "),s("a",_,[n("Ubuntu 官方镜像"),a(e)]),n(),f,n(" 开始构建出一个安装完所有开发和运行时依赖的镜像，您可以根据自己的需要在 Dockerfile 中添加更多依赖。以下是手动构建镜像的 Dockerfile 及方法：")]),S,s("p",null,[n("PolarDB for PostgreSQL 的代码托管于 "),s("a",E,[n("GitHub"),a(e)]),n(" 上，稳定分支为 "),N,n("。如果因网络原因不能稳定访问 GitHub，则可以访问 "),s("a",y,[n("Gitee 国内镜像"),a(e)]),n("。")]),a(t,null,{default:l(()=>[a(i,{title:"GitHub"},{default:l(()=>[R]),_:1}),a(i,{title:"Gitee 国内镜像"},{default:l(()=>[D]),_:1})]),_:1}),P])}const B=r(m,[["render",w],["__file","customize-dev-env.html.vue"]]);export{B as default};
